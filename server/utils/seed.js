...
const seedDB = async () => {
  try {
    ...
    console.log(`${chalk.blue('â')} ${chalk.blue('Seed database started')}`);
    ...
    if (!existingUser) {
      ...
      user.password = hash;
      await user.save();
      console.log(`${chalk.green('â')} ${chalk.green('Admin user seeded.')}`);
    } else {
    ...
    if (categoriesCount >= NUM_CATEGORIES) {
      ...
      console.log(`${chalk.green('â')} ${chalk.green('Categories seeded.')}`);
    }
    ...
    if (brandsCount >= NUM_BRANDS) {
      ...
      console.log(`${chalk.green('â')} ${chalk.green('Brands seeded.')}`);
    }
    ...
    if (productsCount >= NUM_PRODUCTS) {
      ...
      console.log(`${chalk.green('â')} ${chalk.green('Products seeded and associated with categories.')}`);
    }
  } catch (error) {
    ...
    console.log(`${chalk.blue('â')} ${chalk.blue('Database connection closed!')}`);
  }
};
